...
public class configCustomAndSpecificTime extends browserSetup {

    public void negativeCase() throws InterruptedException {
        String orderTime = "asap";
        String orderMode = "Dine In";
        new orderMode(orderMode);
        String slot = new selector().handleSelector(orderMode, "Nineteenth Location", orderTime, null);
    ...
    public void checkAvailableDays() {
        String orderMode = "Dine In";
        new orderMode(orderMode);
        Set<String> enabledWeekDays = new selector().checkDates("Twentieth Location");
    ...
    public void positiveCase() throws InterruptedException {
        ...
        String orderMode = "Dine In";
        new orderMode(orderMode);
        new selector().handleSelector(orderMode, "Twentieth Location", orderTime, null);
        new addMenuItem();
        new cartHeader();
        new guestCheckout();
