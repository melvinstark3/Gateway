...
public class asapDineinETA extends browserSetup {
    public asapDineinETA() throws InterruptedException {
        ...
        System.out.println("CASE: ASAP Timing, Dine In Mode, Minutes ETA");
