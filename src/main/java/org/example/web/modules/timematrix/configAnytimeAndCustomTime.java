...
public class configAnytimeAndCustomTime extends browserSetup {
    public void negativeCase(){
        String orderMode = "Dine In";
        new orderMode(orderMode);
        Set<String> enabledWeekDays = new selector().checkDates("Tenth Location");
    ...
    public void positiveCase() throws InterruptedException {
        ...
        String orderMode = "Dine In";
        new orderMode(orderMode);
        new selector().handleSelector(orderMode, "Tenth Location", orderTime, null);
        new addMenuItem();
        new cartHeader();
        new guestCheckout();
